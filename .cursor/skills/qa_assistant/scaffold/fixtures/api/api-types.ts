 ...
 * @property {Record<string, string>} [extraHeaders] - Additional request headers
 *   merged onto the default headers (e.g. `Surferid`, `Referer`, `Currency`).
 *   Used by genesis storefront-API auth endpoints that read identity from
 *   `Surferid` and require a same-origin `Referer`.
 */
