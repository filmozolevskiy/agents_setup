...
export interface FlighthubPassenger {
    title: 'Mr' | 'Mrs' | 'Ms' | 'Mx';
    firstName: string;
    lastName: string;
    dateOfBirth: string;
 ...
 * @returns A fully-populated adult `FlighthubPassenger`.
 */
export function generateAdultPassenger(
    overrides?: Partial<FlighthubPassenger>
): FlighthubPassenger {
    const defaults: FlighthubPassenger = {
 ...
 *
 * @param overrides - Optional partial overrides for any passenger field.
 * @returns A fully-populated child `FlighthubPassenger`.
 */
 ...
 *
 * The Flighthub storefront enforces "infant must be under 2 at the
 ...
 *
 * @param overrides - Optional partial overrides for any passenger field.
 * @returns A fully-populated infant `FlighthubPassenger`.
 */
