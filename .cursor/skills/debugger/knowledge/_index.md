...
| Ticket not issued, ticketing failed, `AirTicketRQ`, PNR, session close, statement finalization | [`ticketing.md`](ticketing.md) |
| Baggage / seat / ancillary wrong, missing, or mispriced | [`ancillaries.md`](ancillaries.md) |
