...
| [`skill_creator`](../skills/skill_creator/SKILL.md) | Adding, scaffolding, or wiring a new project-local skill: SKILL.md + `.claude/commands/<name>.md` wrapper + routing rows in `CLAUDE.md` and `.cursor/rules/global_setup.md`. |
