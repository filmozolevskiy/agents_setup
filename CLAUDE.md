...
| `/skill_creator`        | Adding, scaffolding, or wiring a new project-local skill: SKILL.md + `.claude/commands/<name>.md` wrapper + routing rows in `CLAUDE.md` and `.cursor/rules/global_setup.md`.                                                     |
